...
begin
  ...
  begin
    MessageDlg('Produto já utilizado em venda!',TMsgDlgType.mtInformation,[mbok],0);
    exit;
  end;
...
begin
  ...
  FUCtrlProdutos.QueryProduto.First;
  //FUCtrlProdutos.QueryProduto.RecNo := FUCtrlProdutos.QueryProduto.RecordCount +1;
...
begin
  HabilitarCampos(true);
  FUCtrlProdutos.QueryProduto.Edit;
  ...
  EdtValor.Text := FUCtrlProdutos.QueryProduto.FieldByName('VALOR_FORMATADO').AsString;
end;
...
begin
  ...
  //FUCtrlProdutos.QueryProduto.FieldByName('VALOR').AsCurrency := StrToCurr('10.51');
end;
