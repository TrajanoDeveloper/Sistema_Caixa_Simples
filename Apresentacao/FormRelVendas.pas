...
begin
  ...
  FUCtrlVendas.CarregarDetalheVenda(FUCtrlVendas.QueryVenda.FieldByName('CODIGO').AsInteger);
...
begin
  text := 'Código da Venda:'+FUCtrlVendas.QueryVenda.FieldByName('CODIGO').AsString;
end;
...
begin
  text := 'Forma de Pagamento: '+ LbFormaPagamento.Caption;
end;
