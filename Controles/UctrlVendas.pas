...
begin
  ...
  QueryDetalheVenda.sql.Add('  CAST(REPLACE(CAST(VD.VALOR_BRUTO AS VARCHAR(20)), ''.'', '','') AS VARCHAR(20)) AS VALOR_BRUTO_FORMATADO,           ');
  QueryDetalheVenda.sql.Add('  VO.DESCRICAO_DESCONTO,                                                                                              ');
  QueryDetalheVenda.sql.Add('  VR.DESCRICAO_RECEITA,                                                                                               ');
  ...
  QueryDetalheVenda.sql.Add('  LEFT JOIN VENDARCEITA VR                                                                                            ');
  QueryDetalheVenda.sql.Add('   ON VR.CODIGO_VENDA = VD.CODIGO                                                                                     ');
  QueryDetalheVenda.sql.Add('  LEFT JOIN VENDADESCONTO VO                                                                                          ');
