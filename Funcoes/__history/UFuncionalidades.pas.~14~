...
class function TFuncionalidades.FormatarTextoValor(PValor: string): string;
var
  S: string;
begin
  S := PValor.Trim;
...
class function TFuncionalidades.FormatarValorTexto(PValor: Double): string;
begin
...
class function TFuncionalidades.BuscarVersaoSistema: String;
var
  InfoSize: DWORD;
  VerBuffer: Pointer;
  FI: PVSFixedFileInfo;
